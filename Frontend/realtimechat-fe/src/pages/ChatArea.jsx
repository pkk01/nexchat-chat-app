...
const ChatArea = () => {
  ...
  const registerPrivateMessageHandler = useCallback((username, handler) => {
    privateMessageHandlers.current.set(username, handler);
  }, []);
          ...
          {Array.from(onlineUsers).map((user) => (
            ...
            >
              <div
                ...
                style={{
                  backgroundColor: user === username ? userColor : "#ccc",
                }}
              >
